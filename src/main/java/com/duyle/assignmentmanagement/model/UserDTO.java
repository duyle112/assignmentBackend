...
public class UserDTO implements Serializable{
	...
	public static UserDTO fromEntity(User user) {
		...
		return new UserDTO(user.getUser_id(),user.getEmail(), user.getPassword(),user.getName(), user.getGender(),user.getRole(), groupDTOs);
	}
	
	public static UserDTO fromEntityByGroupId(User user) {
		return new UserDTO(user.getUser_id(),user.getEmail(), user.getPassword(),user.getName(), user.getGender(), user.getRole(), null);
	}
