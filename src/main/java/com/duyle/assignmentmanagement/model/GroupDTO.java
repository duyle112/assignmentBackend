...
public class GroupDTO {
	...
	public static GroupDTO fromEntity(Group group) {
		return new GroupDTO(group.getGroup_id(), group.getGroup_name(), null, null);
	}
	...
	public static GroupDTO fromEntityListUser(Group group) {
		...
		return new GroupDTO(group.getGroup_id(), group.getGroup_name(), userDTOs, null);
	}
	...
	public static GroupDTO fromEntityGetAssignments(Group group) {
		...
		return new GroupDTO(group.getGroup_id(), group.getGroup_name(), null, assignmentDTOs);
	}
}
